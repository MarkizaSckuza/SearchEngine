...
import com.searchengine.libs.Combinator;
...
public class Clusterer {
    ...
    public boolean isSimilar(Cluster a, Cluster b) {
        ...
        return numIntersectionsAB > (a.getDocList().size() / 2.0) &&
    ...
    public void connectBaseClusters() {
        ...
        Combinator<Integer> combinator = new Combinator<>(clusArr, 2);
        ...
        for (int i = 0; i < baseClusters.size(); i++) {
            ArrayList<Integer> aFinalList = new ArrayList<>();
