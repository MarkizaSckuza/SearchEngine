    ...
    private void findPlaceForSuffix(int i, int w, TrieNode node) {
        ...
        for (int e = 0; e < node.getEdges().size(); e++) {
            ...
            // case 3: sf = bcd vs. ed = bcde
                ...
                newNode.addNewDoc(i);
                newNode.getEdges().add(new ArrayList<>(node.getEdges().get(e).subList(0, ee)));
            ...
            // case 4: bcd vs bck
                ...
                newNode.getDocList().addAll(tempNode.getDocList());
                newNode.addNewDoc(i);
                newNode.getEdges().add(new ArrayList<>(node.getEdges().get(e).subList(ee, node.getEdges().get(e).size())));
                node.getChildren().set(e, newNode);
                ...
                newNode.getEdges().add(new ArrayList<>(snippets.get(i).getStemmedWords().
        ...
        node.getEdges().add(new ArrayList<>(snippets.get(i).getStemmedWords().
